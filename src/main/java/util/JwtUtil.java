...
//        SecretKey key = generalKey();  //签名秘钥，和生成的签名的秘钥一模一样
        Claims claims = Jwts.parser()  //得到DefaultJwtParser
                .setSigningKey(Base64.decodeBase64("45n2f56lkrz1t742btgh8328fr4nuyyg"))         //设置签名的秘钥
...
//        System.out.println(Base64.encodeBase64URLSafeString(encodedKey));//7786df7fc3a34e26a61c034d5ec8245d
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("服务端返回JWT:" + ab);
        ...
        String jwt = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiIxNmxmcjQ3MnRqdDI2dXI2OG04cnJyNXRiMGx4Y3F0MyIsImlhdCI6MTU0NjQxODEyOSwiZXhwIjoxNTQ2NDIwMTI5fQ.eoY-RCjmGOOIHNwSvbNj5kVLbGvR9JTS5efTLsu_cEs";
